...
?>
			...
			<div class="main-page"><h2 class="title1">Organizations</h2>
				...
				<?php
				require("connect.php");
				$sql="SELECT * FROM registration_organisation WHERE verify_status=0";
				...
				if(mysqli_num_rows($res)>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						<tr>
							...
							<td><a class="btn btn-primary" href="showdeatils.php?email=<?php echo $row['organisation_email']?>">View</a> </td>
						</tr>
