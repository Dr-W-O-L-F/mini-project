    ...
    <div class="main">
        ...
        <form onsubmit="return validatePassword()" action="orgreg.php" method="POST" enctype="multipart/form-data">
            <ul class="left-form">
                <h2>New Account:</h2>
                <li>
                    <input type="text" name="full_name" value="<?php echo $row['full_name'] ?>" pattern="^[A-Za-z\s]+$" required/>
                    <div class="clear"> </div>
                </li> 
                <li>
                ...
                <li>
                    <input type="text" name="mobnumber" value="<?php echo $row['mob'] ?>" pattern="^\d{10,11}$" required/>
                    <div class="clear"> </div>
                </li> 
                <li>
                    <input type="text" name="street" value="<?php echo $row['street'] ?>" pattern="^[A-Za-z]+$" required/>
                    <div class="clear"> </div>
                </li> 
                <li>
                    <input type="text" name="district" value="<?php echo $row['district'] ?>" pattern="^[A-Za-z]+$" required/>
                    <div class="clear"> </div>
                </li> 
                <li>
                    <input type="text" name="pincode" value="<?php echo $row['pincode'] ?>" pattern="^\d{6}$" required/>
                    <div class="clear"> </div>
                </li> 
                <li>
                    <input type="password" name="password" value="<?php echo $row['password'] ?>" id="password" pattern="^(?=.*[0-9])(?=.*[a-zA-Z])(?=.*[@#$%^&+=!])(?=\S+$).{8,}$" required/>
                    <div class="clear"> </div>
                </li>
                <li>
                </li> 
                ...
                if ($res1->num_rows > 0) {
                    ...
                    <li>
                        <input type="text" name="your_answer" value="<?php echo $row1['security_answer'] ?>" required/>
                        <div class="clear"> </div>
                    </li> 
                <?php } ?>
